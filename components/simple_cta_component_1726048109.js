...
-->
<template>
    <section id="cta-component" style="min-height: 1790px"   class="bg-gray-50 dark:bg-gray-800 flex-1">
            ...
            <div id="cta-content" class="max-w-screen-sm mx-auto text-center">
                <div id="cta-title-container" class="flex">
                    <h2 id="cta-title" class="flex-1 mb-4 text-3xl font-extrabold leading-tight tracking-tight text-gray-900 dark:text-white">
                        Streamline Your Projects, Amplify Your Success
                    </h2>
                </div>

                <div id="cta-subtitle-container" class="flex">
                    <p id="cta-subtitle" class="flex-1 mb-6 font-light text-gray-500 dark:text-gray-400 md:text-lg">
                        Effortlessly manage tasks, boost team productivity, and achieve your project goals with our intuitive project management solution.
                    </p>
                </div>
