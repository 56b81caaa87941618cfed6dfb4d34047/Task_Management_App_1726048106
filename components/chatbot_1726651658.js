...
INSTRUCTION: - The chatbot_1726651658 sends the user's message along with a "system prompt" to an LLM to get the response. If the user writes about the kind of chatbot they want, include that context in the `system_prompt`, by replacing `PLACEHOLDER_LLM_SYSTEM_PROMPT` with your own written system prompt.
-->
